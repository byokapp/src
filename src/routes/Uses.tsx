            ...
            <Box>
              ...
              <List dense={false}>
                <ListItem disablePadding>
                  ...
                  <ListItemText
                    primary={
                      <ExternalLink href="https://www.coingecko.com/en/terms">
                        CoinGecko
                      </ExternalLink>
                    }
                    secondary={
                ...
                <ListItem disablePadding>
                  ...
                  <ListItemText
                    primary={
                      <ExternalLink href="https://docs.ethers.org/v6/">ethers.js</ExternalLink>
                    }
                ...
                <ListItem disablePadding>
                  ...
                  <ListItemText
                    ...
                    secondary={
                      'strongly-typed programming language (Microsoft) with modern tooling 💯'
                    }
                  />
                </ListItem>
                <ListItem disablePadding>
                ...
                <ListItem disablePadding>
                  ...
                  <ListItemText
                    ...
                    secondary={
                      'bear necessities for React state management - compares to Redux, Jotai'
                    }
                  />
                </ListItem>
                <ListItem disablePadding>
                ...
                <ListItem disablePadding>
                  ...
                  <ListItemText
                    primary={
                      <ExternalLink href="https://apexcharts.com/">Apex Charts</ExternalLink>
                    }
                ...
                <ListItem disablePadding>
                  ...
                  <ListItemText
                    primary={
                      <ExternalLink href="https://emotion.sh/docs/introduction">
                        Emotion
                      </ExternalLink>
                    }
                ...
                <ListItem disablePadding>
                  ...
                  <ListItemText
                    primary={
                      <ExternalLink href="https://code.visualstudio.com/">VSCode</ExternalLink>
                    }
